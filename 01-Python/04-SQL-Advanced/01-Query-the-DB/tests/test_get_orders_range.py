...
class TestOrdersRange(unittest.TestCase):
    ...
    def test_results_0(self):
        ...
        date_to = "2012-03-04"
        results = get_orders_range(db, date_from, date_to)
        expected = [(2, 2, 2, '2012-01-27', '2012-02-01', '2012-01-28', 1, 7.25), (3, 4, 1, '2012-02-19', '2012-02-24', '2012-02-23', 2, 5.5)]
    ...
    def test_results_1(self):
        ...
        date_to = "2012-04-15"
        results = get_orders_range(db, date_from, date_to)
        expected = [(5, 4, 2, '2012-04-05', '2012-04-10', '2012-04-06', 3, 8.75)]
        self.assertEqual(results, expected)
